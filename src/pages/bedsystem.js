            ...
            <div className="2xl:mt-4 xl:mt-1 mt-2 md:leading-none  lg:leading-normal text-gray-700  xl:font-medium my-10">
              ...
              <div className="my-4">
                {language
                  ...
                  : " The system offers convenience, cost-effectiveness, and flexibility for travelers, providing them with comfortable rest during long drives. Additionally, taking short naps during extended work hours can boost productivity, focus, and energy. Owners can also generate passive income by renting the system and offering supplementary services such as meals, restrooms, and shower facilities for additional revenue. This not only helps offset a portion of the vehicle's monthly installments but also facilitates the decision to purchase the vehicle.Lastly, integrating this innovative concept into the vehicle's design process is relatively simple and cost-effective."}
                <br />
              </div>
              {/* <div className="mb-4">
                {language
